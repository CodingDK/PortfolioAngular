...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _PortfolioRoutingModule_6:import7.PortfolioRoutingModule;
  _PortfolioModule_7:import8.PortfolioModule;
  ...
  _RouterInitializer_13:import6.RouterInitializer;
  ...
  __Http_43:any;
  __ROUTES_44:any[];
  __PortfolioService_45:import27.PortfolioService;
  __ROUTER_CONFIGURATION_46:any;
  __LocationStrategy_47:any;
  __Location_48:import28.Location;
  __UrlSerializer_49:import29.DefaultUrlSerializer;
  __RouterOutletMap_50:import30.RouterOutletMap;
  __NgModuleFactoryLoader_51:import31.SystemJsNgModuleLoader;
  __Router_52:any;
  ...
  get _LOCALE_ID_10():any {
    if ((this.__LOCALE_ID_10 == null)) { (this.__LOCALE_ID_10 = import3._localeFactory(this.parent.get(import37.LOCALE_ID,(null as any)))); }
  ...
  get _APP_ID_20():any {
    if ((this.__APP_ID_20 == null)) { (this.__APP_ID_20 = import38._appIdRandomProviderFactory()); }
  ...
  get _EventManager_24():import16.EventManager {
    if ((this.__EventManager_24 == null)) { (this.__EventManager_24 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_23,this.parent.get(import41.NgZone))); }
  ...
  get _NgProbeToken_28():any[] {
    if ((this.__NgProbeToken_28 == null)) { (this.__NgProbeToken_28 = [import6.routerNgProbeToken()]); }
    return this.__NgProbeToken_28;
  }
  get _RootRenderer_29():any {
    if ((this.__RootRenderer_29 == null)) { (this.__RootRenderer_29 = import42._createConditionalRootRenderer(this._DomRootRenderer_27,this.parent.get(import42.NgProbeToken,(null as any)),this._NgProbeToken_28)); }
  ...
  get _AnimationQueue_32():import20.AnimationQueue {
    if ((this.__AnimationQueue_32 == null)) { (this.__AnimationQueue_32 = new import20.AnimationQueue(this.parent.get(import41.NgZone))); }
  ...
  get _PortfolioService_45():import27.PortfolioService {
    if ((this.__PortfolioService_45 == null)) { (this.__PortfolioService_45 = new import27.PortfolioService(this._Http_43)); }
  ...
  get _LocationStrategy_47():any {
    if ((this.__LocationStrategy_47 == null)) { (this.__LocationStrategy_47 = import6.provideLocationStrategy(this.parent.get(import45.PlatformLocation),this.parent.get(import46.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_46)); }
    return this.__LocationStrategy_47;
  }
  get _Location_48():import28.Location {
    if ((this.__Location_48 == null)) { (this.__Location_48 = new import28.Location(this._LocationStrategy_47)); }
    return this.__Location_48;
  }
  get _UrlSerializer_49():import29.DefaultUrlSerializer {
    if ((this.__UrlSerializer_49 == null)) { (this.__UrlSerializer_49 = new import29.DefaultUrlSerializer()); }
    return this.__UrlSerializer_49;
  }
  get _RouterOutletMap_50():import30.RouterOutletMap {
    if ((this.__RouterOutletMap_50 == null)) { (this.__RouterOutletMap_50 = new import30.RouterOutletMap()); }
    return this.__RouterOutletMap_50;
  }
  get _NgModuleFactoryLoader_51():import31.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_51 == null)) { (this.__NgModuleFactoryLoader_51 = new import31.SystemJsNgModuleLoader(this._Compiler_19,this.parent.get(import31.SystemJsNgModuleLoaderConfig,(null as any)))); }
    return this.__NgModuleFactoryLoader_51;
  }
  get _Router_52():any {
    if ((this.__Router_52 == null)) { (this.__Router_52 = import6.setupRouter(this._ApplicationRef_18,this._UrlSerializer_49,this._RouterOutletMap_50,this._Location_48,this,this._NgModuleFactoryLoader_51,this._Compiler_19,this._ROUTES_44,this._ROUTER_CONFIGURATION_46,this.parent.get(import47.UrlHandlingStrategy,(null as any)),this.parent.get(import48.RouteReuseStrategy,(null as any)))); }
  ...
  get _ROUTER_INITIALIZER_58():any {
    if ((this.__ROUTER_INITIALIZER_58 == null)) { (this.__ROUTER_INITIALIZER_58 = import6.getBootstrapListener(this._RouterInitializer_13)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ROUTER_FORROOT_GUARD_4 = import6.provideForRootGuard(this.parent.get(import49.Router,(null as any)));
    ...
    this._ApplicationRef__17 = new import13.ApplicationRef_(this.parent.get(import41.NgZone),this.parent.get(import50.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_15,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_16);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import7.PortfolioRoutingModule)) { return this._PortfolioRoutingModule_6; }
    if ((token === import8.PortfolioModule)) { return this._PortfolioModule_7; }
    if ((token === import9.AppRoutingModule)) { return this._AppRoutingModule_8; }
    if ((token === import1.AppModule)) { return this._AppModule_9; }
    if ((token === import37.LOCALE_ID)) { return this._LOCALE_ID_10; }
    ...
    if ((token === import6.RouterInitializer)) { return this._RouterInitializer_13; }
    ...
    if ((token === import38.APP_ID)) { return this._APP_ID_20; }
    if ((token === import52.DOCUMENT)) { return this._DOCUMENT_21; }
    ...
    if ((token === import53.AnimationDriver)) { return this._AnimationDriver_26; }
    ...
    if ((token === import54.RootRenderer)) { return this._RootRenderer_29; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_30; }
    if ((token === import55.Sanitizer)) { return this._Sanitizer_31; }
    if ((token === import20.AnimationQueue)) { return this._AnimationQueue_32; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_33; }
    if ((token === import56.IterableDiffers)) { return this._IterableDiffers_34; }
    if ((token === import57.KeyValueDiffers)) { return this._KeyValueDiffers_35; }
    ...
    if ((token === import58.XSRFStrategy)) { return this._XSRFStrategy_40; }
    if ((token === import25.XHRBackend)) { return this._XHRBackend_41; }
    if ((token === import26.RequestOptions)) { return this._RequestOptions_42; }
    if ((token === import59.Http)) { return this._Http_43; }
    if ((token === import60.ROUTES)) { return this._ROUTES_44; }
    if ((token === import27.PortfolioService)) { return this._PortfolioService_45; }
    if ((token === import6.ROUTER_CONFIGURATION)) { return this._ROUTER_CONFIGURATION_46; }
    if ((token === import46.LocationStrategy)) { return this._LocationStrategy_47; }
    if ((token === import28.Location)) { return this._Location_48; }
    if ((token === import29.UrlSerializer)) { return this._UrlSerializer_49; }
    if ((token === import30.RouterOutletMap)) { return this._RouterOutletMap_50; }
    if ((token === import61.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_51; }
    if ((token === import49.Router)) { return this._Router_52; }
    ...
    if ((token === import38.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_59; }
